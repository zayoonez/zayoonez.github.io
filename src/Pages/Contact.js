...
import Modal from "../Pages/ContactPage/Components/Modal";
// 이메일이랑 번호
const Container = styled.section`
  /* height: 100vh; */
  background-color: white;
...
const Contact = forwardRef((props, ref) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(
        "https://port-0-promoationpage-server-12fhqa2blnlum4de.sel5.cloudtype.app/api/requests",
        requestData
      )
      .then((response) => {
        ...
        <FormBlock onSubmit={handleSubmit}>
          <FormBlockLeft>
            ...
            <InputFileContainer>
              ...
              />
              <FileLabel htmlFor="uploadfile" className="file-label">
                upload
              </FileLabel>
            </InputFileContainer>
            <InputBlock>
